...
_TRANSLATIONS = {
    "zh": {
        ...
        "consumption.line": "{prefix} {username} → {tokens} tokens · 消耗 {quota} 额度",
        "consumption.line_bound": "{prefix} {username} [QQ:{qq}] → {tokens} tokens · 消耗 {quota} 额度",
        # 退群公告
    ...
    "en": {
        ...
        "consumption.line": "{prefix} {username} → {tokens} tokens · {quota} quota",
        "consumption.line_bound": "{prefix} {username} [QQ:{qq}] → {tokens} tokens · {quota} quota",
